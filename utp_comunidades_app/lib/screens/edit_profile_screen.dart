        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              ListTile(
                leading: Icon(PhosphorIcons.camera, color: const Color(0xFFC8102E)),
                title: const Text(
                  'Tomar foto',
              ...
              ListTile(
                leading: Icon(PhosphorIcons.image, color: const Color(0xFFC8102E)),
                title: const Text(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(PhosphorIcons.heart, color: const Color(0xFFC8102E), size: 22),
  ...
  Widget _buildTextField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(icon, color: const Color(0xFFC8102E), size: 22),
        prefixText: prefix,
