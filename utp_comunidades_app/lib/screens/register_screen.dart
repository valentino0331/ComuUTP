...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  // Colores del diseño
  static const Color colorPrimario = Color(0xFFC8102E);
  ...
  Widget _buildCarreraSelector(bool loading) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(PhosphorIcons.graduationCap, color: Colors.black45, size: 20),
            ...
            Icon(PhosphorIcons.caretDown, color: Colors.black45, size: 20),
          ],
        ),
      ),
    );
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing: isSelected
                        ? Icon(PhosphorIcons.checkBold, color: colorPrimario, size: 20)
                        : null,
                    onTap: () {
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: hint,
          hintStyle: const TextStyle(color: Colors.black45, fontFamily: 'Montserrat'),
          prefixIcon: Icon(PhosphorIcons.lockKey, color: Colors.black45),
          suffixIcon: IconButton(
            icon: Icon(
              mostrar ? PhosphorIcons.eye : PhosphorIcons.eyeSlash,
