    ...
    return Padding(
      ...
      child: Column(
            children: [
              ...
              _buildSectionCard(
                title: 'Apariencia',
                icon: PhosphorIcons.paletteFill,
                children: [
                  _buildSwitchTile(
                    icon: PhosphorIcons.moonFill,
                    title: 'Modo oscuro',
                  ...
                  _buildNavigationTile(
                    icon: PhosphorIcons.translateFill,
                    title: 'Idioma',
                    subtitle: _idioma,
                    onTap: () async {
              ...
              _buildSectionCard(
                ...
                children: [
                  _buildNavigationTile(
                    icon: PhosphorIcons.lockKeyFill,
              ...
              _buildSectionCard(
                ...
                children: [
                  _buildInfoTile(
                    icon: PhosphorIcons.appWindowFill,
          ...
          children: [
            ...
            ...languages.map((lang) => ListTile(
              ...
              trailing: _idioma == lang
                  ? const Icon(Icons.check, color: Color(0xFFC8102E))
                  : null,
              onTap: () {
