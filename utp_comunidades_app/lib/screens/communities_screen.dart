                ...
                : filteredCommunities.isEmpty
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: _buildCommunityCard(filteredCommunities[index]).animate().fade(delay: (index * 50).ms).slideX(begin: 0.1),
                      );
                    },
                  ),
          ),
  ...
  Widget _buildMembersButton(BuildContext context, Community community) {
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
        decoration: BoxDecoration(
          color: Color(0xFFC8102E).withOpacity(0.1),
          borderRadius: BorderRadius.circular(8),
          border: Border.all(color: Color(0xFFC8102E), width: 1),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(PhosphorIcons.usersThreeFill, size: 12, color: Color(0xFFC8102E)),
            const SizedBox(width: 4),
            const Text(
              'Ver Miembros',
              style: TextStyle(
    ...
    return GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '¿Estás seguro de que quieres salir de "${community.nombre}"? Ya no verás las publicaciones de esta comunidad.',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
                      fontSize: 14,
      ...
      child: Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(PhosphorIcons.signOutFill, size: 12, color: Colors.red),
            const SizedBox(width: 4),
            const Text(
              'Salir',
              style: TextStyle(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(PhosphorIcons.trashFill, size: 12, color: Colors.red),
            const SizedBox(width: 4),
            const Text(
              'Eliminar',
              style: TextStyle(
