...
class _HomeScreenState extends State<HomeScreen> {
  ...
  /// Build AppBar Épico con Gradiente UTP
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0xFFB21132).withOpacity(0.5),
                                blurRadius: 6,
                                offset: const Offset(0, 2),
                              ),
                            ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.post.imagen != null && widget.post.imagen!.isNotEmpty)
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
              child: ClipRRect(
