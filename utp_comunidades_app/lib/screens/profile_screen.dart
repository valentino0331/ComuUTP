        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: user.esPremium ? const Color(0xFFC8102E) : Colors.transparent,
                width: 4,
              ),
              boxShadow: [
                BoxShadow(
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFFC8102E), width: 2),
                ),
                child: Material(
...
height: 100,
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [const Color(0xFFC8102E), const Color(0xFFC8102E).withOpacity(0.7)],
                ...
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      icon: Icon(PhosphorIcons.linkBold),
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      icon: Icon(PhosphorIcons.shareFatBold),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: const LinearGradient(
                  colors: [Color(0xFFC8102E), Color(0xFFE83E8C)],
                ),
                boxShadow: [
                  BoxShadow(
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildPremiumFeature('Crea comunidades ilimitadas', PhosphorIcons.usersThreeFill),
                  const SizedBox(height: 12),
                  _buildPremiumFeature('Sin necesidad de asistencias', PhosphorIcons.checkCircleFill),
                  const SizedBox(height: 12),
                  _buildPremiumFeature('Badge premium exclusivo', PhosphorIcons.sealFill),
                  const SizedBox(height: 12),
                  _buildPremiumFeature('Soporte prioritario', PhosphorIcons.headsetFill),
                ],
              ),
            ),
            const SizedBox(height: 24),
  ...
  Widget _buildPremiumPlanCard2(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isRecommended 
            ? const Color(0xFFC8102E).withOpacity(0.2)
                    ...
                    children: [
                      ...
                      _buildSettingsSection(
                        ...
                        items: [
                          ...
                          (
                            icon: PhosphorIcons.fingerprintBold,
                            title: 'Autenticación',
                      ...
                      if (user?.role == 'admin') ...[
                        _buildSettingsSection(
                          ...
                          items: [
                            (
                              icon: PhosphorIcons.userGearBold,
                      ...
                      _buildSettingsSection(
                        ...
                        items: [
                          (
                            icon: PhosphorIcons.notepadBold,
                          ...
                          (
                            icon: PhosphorIcons.questionBold,
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      ...
                      colors: [Color(0xFFC8102E), Color(0xFFD32F5A)],
                    ),
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Center(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildFAQItem(
                ...
                icon: PhosphorIcons.userPlusBold,
              ),
              _buildFAQItem(
              ...
              Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  color: const Color(0xFFC8102E).withOpacity(0.05),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(color: const Color(0xFFC8102E).withOpacity(0.2)),
                ),
                child: Row(
                  children: [
                    Icon(
