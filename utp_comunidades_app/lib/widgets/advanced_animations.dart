...
class _InteractiveMascotState extends State<InteractiveMascot> {
  ...
  /// Fallback: Mascota animada con la nueva imagen premium
    ...
    return Container(
      child: Stack(
        children: [
          ...
          // Imagen del Robot Premium
          Center(
            child: ShaderMask(
              shaderCallback: (rect) {
                return const RadialGradient(
                  colors: [Colors.white, Colors.transparent],
                  stops: [0.9, 1.0], // Minimal fading at the very edges
                ).createShader(rect);
              },
  ...
  Widget _buildStatusOverlay() {
    if (widget.state == MascotState.idle || widget.state == MascotState.happy) {
    ...
    return Positioned.fill(
      child: Container(
        ...
        child: Center(
          child: _buildAnimatedFace(), // Reutilizamos los íconos para estados especiales
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: widget.backgroundColor ?? const Color(0xFFC8102E),
          borderRadius: BorderRadius.circular(16),
          boxShadow: [
            if (!_isPressed)
              BoxShadow(
                color: (widget.backgroundColor ?? const Color(0xFFC8102E)).withOpacity(0.4),
    ...
    final card = Container(
      ...
      child: ClipRRect(
        ...
        child: Material(
          ...
          child: InkWell(
            onTap: onTap,
            splashColor: const Color(0xFFC8102E).withOpacity(0.1),
            highlightColor: const Color(0xFFC8102E).withOpacity(0.05),
            child: child,
          ),
        ),
      ),
