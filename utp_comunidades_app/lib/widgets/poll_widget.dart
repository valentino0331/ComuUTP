      ...
      child: Container(
        ...
        child: Stack(
          children: [
            Container(
              decoration: BoxDecoration(
                color: isSelected ? const Color(0xFFC8102E).withOpacity(0.1) : Colors.white,
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                  color: isSelected ? const Color(0xFFC8102E) : Colors.grey[300]!,
                    ...
                    if (showResults)
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight: FontWeight.w700,
                          fontSize: 14,
                          color: isSelected ? const Color(0xFFC8102E) : Colors.grey[600],
                        ),
                      ),
                  ],
                ),
