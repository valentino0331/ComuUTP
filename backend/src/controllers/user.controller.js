  ...
  try {
    ...
    const result = await pool.query(
      `UPDATE usuarios 
         ...
         modo_oscuro = COALESCE($8, modo_oscuro),
         privacidad_perfil_publico = COALESCE($9, privacidad_perfil_publico),
         privacidad_mostrar_email = COALESCE($10, privacidad_mostrar_email),
